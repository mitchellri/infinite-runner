	...
	function Objects:draw() --pass in self
		--where I use the char to show on the screen
		love.graphics.rectangle("fill", 0,50, 40,120)
	end 

	-- function Objects:
	-- function Objects.move(timer)
	-- 	Objects.move += timer*speed
	-- end

	function Objects.Character.new(world)
		newcharacter = {}
	...
	function Objects.Floor.new(world)
		newcharacter = {}
